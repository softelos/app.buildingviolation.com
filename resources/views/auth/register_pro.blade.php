...
@section('pageName','New Pro Account')
@section('pageTitle','New Pro Account')
...
<section id="register-user" class="autocenter">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			{!! Form::open(['method'=>'POST','url'=>'/signup-pro']) !!}
				...
				<div class="form-group">
					...
					{!! Form::select('pro_type',$pro_types,null,['class'=>'form-control']) !!}
				</div>	
				<div class="form-group text-center">
					{!! Form::button('<i class="fa fa-sign-in"></i> Send',['type'=>'submit','class'=>'btn btn-default']) !!}
				</div>
